...
#No es momento de elegir (hay q testear flipeando los booleanos del estado de juego)
...
def test_choose_candidate():
    ...
    vote_response = testc.post("/api/games/2/director/10", headers={"Authorization": token}, json={"vote":"false"})
