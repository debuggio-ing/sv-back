...
def populate_test_db():
    ...
    last_vote1 = PublicVote(game=game1.id, player=p1, vote=True, voter_id=1)
    last_vote2 = PublicVote(game=game1.id, player=p2, vote=True, voter_id=2)
    last_vote3 = PublicVote(game=game1.id, player=p3, vote=True, voter_id=3)
    last_vote4 = PublicVote(game=game1.id, player=p4, vote=True, voter_id=4)
    last_vote4 = PublicVote(game=game1.id, player=p5, vote=True, voter_id=5)

    last_vote10 = PublicVote(game=game2.id, player=p6, vote=True, voter_id=6)
    last_vote20 = PublicVote(game=game2.id, player=p7, vote=True, voter_id=7)
    last_vote30 = PublicVote(game=game2.id, player=p8, vote=True, voter_id=8)
    last_vote40 = PublicVote(game=game2.id, player=p9, vote=True, voter_id=9)
    last_vote40 = PublicVote(game=game2.id, player=p10, vote=True, voter_id=10)
